            ...
            if($("#uname").val()==null || $("#uname").val()==""){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.result == 1) {
                            $("#nameCheck").html("<font color='red'>抱歉！用户</font>" + $("#uname").val() + "<font color='red'>不存在！</font>");
        ...
        $(function () {
            ...
            $("#code").blur(function () {
                if ($("#nameChack").html() != null || $("#uname").val() == "") {
                    layer.msg('用户名不正确', {icon: 2, time: 1000});
                    return;
...
<section class="Psection MT20">
    <form action="<%=basePath%>userBuyPassword.html" method="post" id="registerForm">
        <table class="Register">
            ...
            <tr>
                ...
                <td><input type="button" name="" id="sub" class="Submit_b" value="确认">( 已经是会员，<a href="<%=basePath%>user/userBuylogin.html" class="BlueA">请登录</a> )</td>
            </tr>
        </table>
    </form>
</section>

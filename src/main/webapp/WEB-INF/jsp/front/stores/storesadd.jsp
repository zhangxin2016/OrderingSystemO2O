...
<article class="page-container" style="padding-top: 1%;width: 90%;margin-left: 5%;">
	...
	<form action="<%=basePath %>addstores.html" method="post" class="form form-horizontal" id="demoform-2" novalidate="novalidate" enctype="multipart/form-data">

		<legend class="col-xs-12" style="font-size: 16px;padding: 0px;margin-top: 10px;margin-bottom: 0px;">请输入餐厅名字:</legend>
		<input type="text" class="input-text" name="stname" value="" id="stname" >
		...
		<select name="stypeid" style="font-size: 16px; padding: 0px;margin-top: 10px;">
			<c:forEach	items="${storestypeList }" var="storestype">
				<option value="${storestype.stypeid }">${storestype.stypename }</option>
			</c:forEach>
		</select>

...
<article class="page-container" style="padding-top: 1%;width: 90%;margin-left: 5%;">
	...
	<form action="<%=basePath %>frontEditFood.html" method="post" class="form form-horizontal" id="demoform-2" novalidate="novalidate">
		...
		<input type="text" class="input-text" name="fpic" value="${editFoodByStid.fpic}" id="stdesc" >

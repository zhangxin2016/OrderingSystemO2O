...
<article class="page-container" style="padding-top: 1%;width: 90%;margin-left: 5%;">
	...
	<form action="<%=basePath %>userUpdateAddress.html" method="post" class="form form-horizontal" id="demoform-2" novalidate="novalidate" enctype="multipart/form-data">
		<input type="hidden" name="adid" value="${userUpdateAddress.adid}"/>
		<legend class="col-xs-12" style="font-size: 16px;padding: 0px;margin-top: 10px;margin-bottom: 0px;">请输入姓名:</legend>
		<input type="text" class="input-text" name="adname" value="${userUpdateAddress.adname}" id="adname" >
		...
		<input type="text" class="input-text" name="adtel" value="${userUpdateAddress.adtel}" id="adtel" >
...
<script type="text/javascript">
    $(function(){
        ...
        if(call_flag=="close"){
            ...
            parent.toUpdateAddress_callback();

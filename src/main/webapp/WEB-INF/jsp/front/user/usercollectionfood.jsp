        ...
        <section class="ShopFav Overflow">
            ...
            <ul>
                <a href="shop.html" target="_blank">
                    <c:forEach items="${collectionFoodList }" var="collectionFoodList">
                        <li>
                            <a href="<%=basePath%>getFoodById.html?fid=${collectionFoodList.fid}"><img src="/pic/${collectionFoodList.food.fpic }"></a>
                            <p>${collectionFoodList.food.fname } <a href="<%=basePath%>deleteCollectionFood.html?collid=${collectionFoodList.collid}">( 删除 )</a></p>
                        </li>
                    </c:forEach>
                </a>
            </ul>

    ...
    <section class="Fsl">
        ...
        <aside>
            ...
            <c:forEach items="${storesListTwo }" var="storesListTwo">
                <div class="C-list">
                    <a href="<%=basePath%>userBuyToStores.html?stid=${storesListTwo.stid }" target="_blank" title="店铺名称"><img src="/pic/${storesListTwo.stdesc }" width="284px" height="200px"></a>
                    <p><a href="<%=basePath%>userBuyToStores.html?stid=${storesListTwo.stid }" target="_blank">${storesListTwo.stname }</a></p>
                    <p>

    ...
    <form class="form form-horizontal" method="post">
            ...
            <div class="row cl" align="center">
                ...
                <div class="formControls col-xs-8 col-sm-3">
                    <input type="button" class="input-text" value="${findstoresByFood.fname}" placeholder="名称" id="fname"
                           name="stname">
                </div>
            </div>
        <div class="row cl" align="center">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <input type="button" class="input-text" value="${findstoresByFood.stores.stname}" placeholder="名称" id="stname"
                       name="stname">
            </div>
        </div>
        <div class="row cl" align="center">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <input type="button" class="input-text" value="${findstoresByFood.stores.staddress}" placeholder="名称" id="staddress"
                       name="stname">
            </div>
        </div>
        <div class="row cl" align="center">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <img src="/pic/${findstoresByFood.stores.stdesc}" width="100px" height="60px">
            </div>
        </div>

...
<article class="page-container">
    ...
    <form class="form form-horizontal" method="post">
            ...
            <div class="row cl" align="center">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>商家姓名：</label>
                <div class="formControls col-xs-8 col-sm-3">
                    <input type="button" class="input-text" value="${storesListByUserSell.usname}" placeholder="名称" id="fname"
                           name="stname">
                </div>
            </div>
        <div class="row cl" align="center">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <input type="button" class="input-text" value="${storesListByUserSell.stores.stname}" placeholder="名称" id="stname"
                       name="stname">
            </div>
        </div>
        <div class="row cl" align="center">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <input type="button" class="input-text" value="${storesListByUserSell.stores.staddress}" placeholder="名称" id="staddress"
                       name="stname">
            </div>
        </div>
        <div class="row cl" align="center">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <img src="/pic/${storesListByUserSell.stores.stdesc}" width="100px" height="60px">
            </div>
        </div>

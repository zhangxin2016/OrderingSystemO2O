...
<article class="page-container">
	...
	<form class="form form-horizontal" action="<%=basePath%>back/admin/update.html" method="post">
	...
	<div class="row cl" align="center">
		...
		<div class="formControls col-xs-8 col-sm-3">
			<input type="text" class="input-text" value="${admin.aname}" placeholder="名称" id="aname" name="aname">
		</div>
	</div>
	<div class="row cl" align="center">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>管理员密码：</label>
		<div class="formControls col-xs-8 col-sm-3">
			<input type="text" class="input-text" autocomplete="off" value="${admin.apassword }" placeholder="密码" id="apassword" name="apassword">
		</div>
	</div>

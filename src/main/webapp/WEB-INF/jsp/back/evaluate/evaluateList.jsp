		...
		<div id="tab_demo" class="HuiTab">
			...
			<div class="tabCon">
				<table
					...
					<thead>
						<tr class="text-c">
							<th width="80" class="hidden-xs1">订单编号</th>
							<th width="100" class="hidden-xs2">买家评论</th>
							<th width="100" class="hidden-xs4">买家评论日期</th>
							<th width="100" class="hidden-xs3">卖家回复</th>
							<th width="100" class="hidden-xs4">卖家回复日期</th>
							<%--<th width="150">权限</th>--%>
							<th width="150">操作</th>
					...
					<tbody id="table_all">
						<c:forEach items="${evaluateListBack}" var="evaluateListBack">
							<tr class="text-c">
								...
								<td class="td-manage">
									...
									onclick="findDetailOrder('查看订单信息','<%=basePath%>finddetailOrderListByDoid.html?doid=${evaluateListBack.doid}','600','500')"
				...
				<td colspan="8">
					<!-------------------------------分页插件↓----------------------------------------------------------------->
					<form action="<%=basePath%>getAllEvaluateBack.html" method="POST" name="spForm" id="spForm">
...
//复选框
	function checkAll() {
        ...
        function findDetailOrder(title,url,w,h){
